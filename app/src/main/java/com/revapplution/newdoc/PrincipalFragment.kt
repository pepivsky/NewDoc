...
class PrincipalFragment : Fragment() {
    ...
    lateinit var fabNuevo: FloatingActionButton
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fabNuevo = view.findViewById(R.id.floatingActionButton)
        fabNuevo.setOnClickListener {
            val intent = Intent(activity, NuevoTramiteActivity::class.java)
